...
<head>
    ...
    <link rel="stylesheet" href="Frontlisteencours - Copie/assets/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i&amp;display=swap">
    <link rel="stylesheet" href="Frontlisteencours - Copie/assets/fonts/fontawesome-all.min.css">
</head>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Historique enchere</p>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <%for(int i=0;i<liste.size();i++){%>
                                            <tr>
                                                ...
                                                <%Utilisateur u=(Utilisateur)liste.get(i).getgagnant()[0]; 
                                                  Double p=Double.parseDouble(liste.get(i).getgagnant()[1].toString());
                                                %>
                                                <td><%out.print(u.getNom()+" "+u.getPrenom());%></td>
                                                <td><%out.print(p);%></td>
                                            </tr>
                                        <%}%>
                                    </tbody>
    ...
    <script src="Frontlisteencours - Copie/assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="Frontlisteencours - Copie/assets/js/bs-init.js"></script>
    <script src="Frontlisteencours - Copie/assets/js/theme.js"></script>
</body>
